...
public class MstucaDB {
	// TODO Cache table
	// TODO favorites tables
	public static final String DATABASE_NAME = "mstuca.db";
	public static final int DATABASE_VERSION = 1;

	public static final String TABLE_GROUPS = "tbgroups";
	public static final String TABLE_GROUPS_FIELD_ID = "_id";
	...
	public static final String TABLE_TEACHERS_FIELD_ID = "_id";
	...
	public static class MstucaDBHelper extends SQLiteOpenHelper {
		public MstucaDBHelper(Context context) {
